...
- Worker/CDN configuration stays in the consuming app; v1 browser harness and examples/monaco-playground use CDN loader paths (Vite MonacoEnvironment + ?worker documented as an alternative in README).
