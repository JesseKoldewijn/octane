...
const FIXTURE = 'packages/monaco-editor-octane/tests/hydration/_fixtures/hydrate.tsrx';
...
describe('@octanejs/monaco-editor-octane — hydration', () => {
	it('adopts the server section and reaches a ready editor on the client', async () => {
		const server = await renderHydrationFixture('monaco-editor-octane', FIXTURE, 'HydratePage', {});
