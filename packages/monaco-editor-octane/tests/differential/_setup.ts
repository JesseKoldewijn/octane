/**
 * Precompile Monaco differential fixtures for React against the pinned
 * @monaco-editor/react oracle.
 */
...
function compileOne(sourcePath: string): void {
	...
	const rewritten = transformed.code
		.replace(/from\s+["']@octanejs\/monaco-editor-octane["']/g, 'from "@monaco-editor/react"')
