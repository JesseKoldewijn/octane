...
- Upstream Vitest suite is snapshot-only (4 files). Port-authored lifecycle (language/theme/path/viewState/onValidate/options, DiffEditor keep/remount), differential, SSR/hydration, Chromium browser, and example e2e supply behavioral parity.
